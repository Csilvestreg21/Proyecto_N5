...
class HomePage {
  ...
  static selectDestination(destination){
    ...
    .wait(5000); // Esperar 5 segundos (5000 milisegundos)
  }
  static selectSearchFlight(){
    ...
    cy.wait(3000);
    cy.get('[data-test="cd03916aa5"] > .cardFlightstyle__WrapperCardShadow-sc__sc-1fa5kbc-0 > .cardFlightstyle__CardExpander-sc__sc-1fa5kbc-2').click();
    cy.get('[data-testid="bundle-detail-3-flight-select"]').click();
    cy.wait(10000);
  }
  ...
  static selectSeatOrigin(){
    ...
    cy.get('.bodyFlightsstyle__WrapperBodyFlightContainer-sc__sc-1g00tx2-1 > #WrapperBodyFlights > #CenterWrapperBodyFlights > #container-continue > #button9').click()
    cy.visit('https://www.latamairlines.com/co/es/seleccion-asientos?id=LA0351546FYHG')
    cy.wait(4000);
    cy.get(':nth-child(2) > :nth-child(3) > .MapSlot__SeatContent-sc-18zijkx-4 > .Seat__ButtonSeat-sc-1xsdv1h-0').click()
    cy.wait(4000);
    cy.get(':nth-child(3) > :nth-child(2) > .MapSlot__SeatContent-sc-18zijkx-4 > .Seat__ButtonSeat-sc-1xsdv1h-0').click()
    cy.wait(4000);
